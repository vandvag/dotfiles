...
export declare type Node = TextString | Command | AmsMathTextCommand | Environment | Group | OptionalArg | InlienMath | DisplayMath | MathCharacter | MathMatchingParen | MathEnv | MathEnvAligned | Parbreak | Superscript | Subscript | AlignmentTab | CommandParameter | ActiveCharacter | Ignore | Verb | Verbatim | Minted | Lstlisting;
