return {
  ...
  keys = {
    ...
    { "<leader>fe",       function() Snacks.picker.explorer() end,                                           desc = "Toggle File explorer" },
    { "<leader>fc",       function() Snacks.picker.files({ layout = "vscode", cwd = "~/.config/nvim" }) end, desc = "Find files in neovim configuration" },
    ...
    { "<leader>cx",       function() Snacks.picker.diagnostics({ layout = "right" }) end,                    desc = "Show workspace diagnostics" },
    { "<leader>cb",       function() Snacks.picker.buffer_diagnostics({ layout = "right" }) end,             desc = "Show buffer diagnostics" },
