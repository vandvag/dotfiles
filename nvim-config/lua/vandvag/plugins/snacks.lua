return {
  ...
  keys = {
    ...
    { "<leader>cx",       function() Snacks.picker.diagnostics({ layout = "sidebar" }) end,        desc = "Show workspace diagnostics" },
    { "<leader>cb",       function() Snacks.picker.buffer_diagnostics({ layout = "sidebar" }) end, desc = "Show buffer diagnostics" },
